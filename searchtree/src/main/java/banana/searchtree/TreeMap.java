package banana.searchtree;


import banana.map.AbstractSortedMap;

import java.util.ArrayList;
import java.util.Comparator;
import java.util.List;

import banana.map.Entry;
import banana.positionallist.Position;

/**
 * An implementation of a sorted map using a binary search tree
 *
 * Running time (average, assuming a random series of insertions and removals)
 * size, isEmpty : O(1)
 * get, put, remove : O(h)
