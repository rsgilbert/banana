...
public interface PositionalList<E> {
    /**
     * Returns the number of {@link Position}s in the list.
     *
    ...
    /**
     * Returns {@code true} if the list has no {@link Position}s.
     *
    ...
    /**
     * Returns the first {@link Position} in the list or null if the list is empty.
     *
    ...
    /**
     * Returns the last {@link Position} in the list or null if the list is empty.
     *
    ...
    /**
     * Returns the {@link Position} immediately before {@link Position} p or null if p is the first {@link Position} in the list.
     *
     * @param p @{@link Position} whose before-position is to be returned.
    ...
    /**
     * Returns the {@link Position} immediately after {@link Position} p or null if p is the last {@link Position} in the list.
     *
     * @param p {@link Position} whose after-position is to be returned.
    ...
    /**
     * Inserts element e to the start of the list and returns its new {@link Position}.
     *
    ...
    /**
     * Inserts element e to the end of the list and returns its new {@link Position}.
     *
    ...
    /**
     * Inserts element e immediately after {@link Position} p and returns {@link Position} of e.
     *
    ...
    /**
     * Replaces the element stored at {@link Position} p and returns the replaced element.
     *
    ...
    /**
     * Removes {@link Position} p from the list and returns the element stored at {@link Position} p.
    ...
    /**
     * Returns an iterable of the list's {@link Position}s.
     *
